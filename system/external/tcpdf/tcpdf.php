...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		 ...
		 * @access public
		 */
		public function setHeaderData($ln='', $lw=0, $ht='', $hs='' , $hse='') {
			$this->header_logo = $ln;
			$this->header_logo_width = $lw;
			$this->header_title = $ht;
			$this->header_string = $hs;
			$this->header_string_email = $hse;
		}
		...
		public function getHeaderData() {
			...
			$ret['string_email'] = $this->header_string_email;
			return $ret;
		}
		...
		$this->SetTextColor(238, 84, 173);
			...
			$this->SetFont($headerfont[0], $headerfont[1], $headerfont[2]);
			$this->SetX($header_x);
			$this->MultiCell(0, $cell_height, $headerdata['string_email'], 0, '', 0, 1, '', '', true, 0, false);
		...
		public function Footer() {
			...
			if (empty($this->pagegroups)) {
				$bungaText="Make payment to PT Bungaindo";
				$thankYou="Thank - You";
				$rek1="REK BCA1"."         "."REK BCA2";
			...
			if ($this->getRTL()) {
				$this->SetX($ormargins['left']);
				$this->Cell(0, 0, $bungaText, 'T', 0, 'L');
				
				//$this->SetX($ormargins['right']);
				//$this->Cell(0, 0, $pagenumtxt, 'T', 0, 'L');
				$this->SetX($ormargins['right']);
				$this->Cell(0, 0, $rek1, 'T', 0, 'C');
				
				
				$this->SetX($ormargins['right']);
				$this->Cell(0, 0, $thankYou, 'T', 0, 'R');
