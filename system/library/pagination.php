...
class Pagination {
	...
	public function render() {
		...
		if ($num_pages > 1) {
   		...
   		if ($page < $num_pages && $num_pages > $num_links) {
			...
			$output .= ' <a class="c" href="' . str_replace('{page}', $page + 1, $this->url) . '">' . $this->text_next . '</a>';
		}
