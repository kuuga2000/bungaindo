          ...
          <td>Payment To</td>
		   ...
		   <td>
            <select name="payment_to">
                <option value="BCA (2418018777) a/n Tan Kong Ie Isaphira T">BCA (2418018777) a/n Tan Kong Ie Isaphira T</option>
                <option value="Mandiri (900-00-0482321-8) a/n Tan Kong Ie Isaphira T">Mandiri (900-00-0482321-8) a/n Tan Kong Ie Isaphira T</option>
