       ...
       <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      	<b class="edit-heading" style="padding-top:0px;">Personal Information:</b>
           ...
           <th> <?php echo $entry_country; ?></th>
                <td align="center" valign="middle" class="dot">:</td>
          	<td><select name="country_id" style="width:135px;">
            ...
            <?php } ?></td>
              <th> Province</th>
              <td align="center" valign="middle" class="dot">:</td>
              <td><select name="zone_id" onchange="$('select[name=\'city\']').load('index.php?route=account/login_register/city&zone_id=' + this.value);" style="width:135px;"></select>
                <?php if ($error_zone) { ?>
                <span class="error"><?php echo $error_zone; ?></span>
                <?php } ?></td>
                <th> <?php echo $entry_city; ?></th>
                <td align="center" valign="middle" class="dot">:</td>
            <td><div id="cityColumn"></div><!--<input type="text" name="city" value="<?php echo $city; ?>" />-->
              <?php if ($error_city) { ?>
