...
<div id="content"><?php echo $content_top; ?>
 ...
 <!-- <div class="breadcrumb">
  ...
  <div class="cart-tab">
  	<ul>
    	<li class="active"><a href="#">Cart</a><i></i></li>
        <li><a href="#" class="sec-tab">Shipping Address</a><i></i></li>
        <li><a href="#" class="third-tab">Payment</a><i></i></li>
        <li><a href="#">Success</a><i></i></li>
    </ul>
  </div>
