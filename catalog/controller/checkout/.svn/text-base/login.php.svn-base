...
class ControllerCheckoutLogin extends Controller { 
	...
	public function validate() {
		...
		$strActivation = $this->model_account_customer->checkCustomerActivation($this->request->post['email'],$this->request->post['password']);
		...
		{
			$json['error']['warning'] = $this->language->get('error_activation');
		}
		if (!$json) {
