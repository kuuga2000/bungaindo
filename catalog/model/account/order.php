	...
	*/	
	...
	public function processOrderPayment($data)
	{
		...
		$date = date('Y-m-d',$paymentDate);
		 $SQL = "UPDATE ". DB_PREFIX ."order_customer_payment set payment_to = '".$data['payment_to']."',payment_from= '".$data['payment_from']."',account_name= '".$data['account_name']."',total_amount= '".$data['total_amount']."',payment_date= '".$date."', status ='confirm' WHERE order_id = '".(int)$data['order_id']."' ";
