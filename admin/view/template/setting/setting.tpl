          ...
          <table class="form">
            ...
            <tr>
             ...
             <tr>
              ...
              <td><input type="text" name="config_bbpin" value="<?php echo $config_bbpin; ?>" />
               </td>
            </tr>
             </tr>
             <tr>
              <td>Facebook Url:</td>
              <td><input type="text" name="config_fb" value="<?php echo $config_fb; ?>" />
               </td>
            </tr>
             <tr>
              <td>Twitter Url:</td>
              <td><input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>" />
               </td>
            </tr>
             <tr>
              <td>Instagram Url:</td>
              <td><input type="text" name="config_instagram" value="<?php echo $config_instagram; ?>" />
               </td>
            </tr>
            ...
            <tr>
              <td><span class="required">*</span><?php echo $entry_order_duration; ?></td>
              <td><input type="text" name="config_order_duration" value="<?php echo $config_order_duration; ?>" />
              <?php if ($error_order_duration) { ?>
                <span class="error"><?php echo $error_order_duration; ?></span>
                <?php } ?></td>
            </tr>
          </table>
        </div>
