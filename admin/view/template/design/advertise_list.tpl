      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($advertise['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $advertise['name']; ?></td>
              <td class="left"><?php echo $advertise['status']; ?></td>
              <td class="right"><?php foreach ($advertise['action'] as $action) { ?>
