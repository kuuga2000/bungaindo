        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
			  ...
			  <tr>
			  	<td><?php echo $entry_highlighted_product; ?></td>
				<td><input  type="text" name="highlight_product" id="highlight_product" value="<?php echo $highlight_product; ?>"/><input type="hidden" id="highlight_product_id" name="highlight_product_id" value="<?php echo $highlight_product_id; ?>"/></td>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
			 ...
			 <tr>
              <td>Banner image</td>
              <td valign="top"><div class="image"><img src="<?php echo $bannerImageThumb; ?>" alt="" id="bannerImageThumb" />
                  <input type="hidden" name="bannerImage" value="<?php echo $bannerImage; ?>" id="bannerImage" />
                  <br />
                  <a onclick="image_upload('bannerImage', 'bannerImageThumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#bannerImageThumb').attr('src', '<?php echo $no_image; ?>'); $('#bannerImage').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
...
var categoryId = '<?php echo $this->request->get['category_id']; ?>'; 
$('input[name=\'highlight_product\']').autocomplete({
	delay: 500,
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term)+ '&filter_category_id='+categoryId,
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		$('#highlight_product').val(ui.item.label);
		$('#highlight_product_id').val(ui.item.value)
		return false;
	},
	focus: function(event, ui) {
      return false;
