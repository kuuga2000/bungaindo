          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'p.model') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'p.upselling') { ?>
                <a href="<?php echo $sort_upselling; ?>" class="<?php echo strtolower($order); ?>">Upselling</a>
                <?php } else { ?>
                <a href="<?php echo $sort_upselling; ?>">Upselling</a>
                <?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td><input type="text" name="filter_model" value="<?php echo $filter_model; ?>" /></td>
               <td><input type="text" name="filter_upselling" value="<?php echo $filter_upselling; ?>" /></td>
            ...
            <tr>
              ...
              <td class="left"><?php if ($product['upselling']=='1') echo "Yes"; else echo "No"; ?></td>
