      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <?php if ($upselling=='1') $checked = 'checked="checked"'; else $checked=''; ?>
                <td><?php echo $entry_upselling; ?></td>
                <td><input type="checkbox" value="1" name="upselling" <?php echo $checked; ?> /></td>
              </tr>
              <tr>
        ...
        <div id="tab-data">
          <table class="form">
			...
			<tr>
				<td>Shipping method</td><td><input type="radio" name="shippingMethod" value="Shipped in a Gift Box" <?php if($shippingMethod == 'Shipped in a Gift Box'){ ?> checked="checked" <?php } ?> >Shipped in a Gift Box&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  type="radio" name="shippingMethod" value="Local delivery"  <?php if($shippingMethod == 'Local delivery'){ ?> checked="checked" <?php } ?> />Local delivery   </td>
			</tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
              ...
              <?php if ($watermark=='1') $checked = 'checked="checked"'; else $checked=''; ?>
                <td>Watermark:</td>
                <td><input type="checkbox" value="1" name="watermark" <?php echo $checked; ?> /></td>
              </tr>
            <tr>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>  
                ...
                <td class="right"><input type="text" name="product_discount[<?php echo $discount_row; ?>][percentage]" value="<?php echo $product_discount['percentage'].'%'; ?>" /></td>
                <td class="right"><input type="text" name="product_discount[<?php echo $discount_row; ?>][price]" value="<?php echo $product_discount['price']; ?>" readonly="readonly" /></td>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><input type="hidden" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo $price; ?>" /><input type="text" name="product_special[<?php echo $special_row; ?>][date_start]" value="<?php echo $product_special['date_start']; ?>" class="date" /></td>
...
function addDiscount() {
	...
	html += '    <td class="right"><input type="text" name="product_discount[' + discount_row + '][percentage]" value="" /></td>';
	html += '    <td class="right"><input type="text" name="product_discount[' + discount_row + '][price]" value="" readonly="readonly" /></td>';
...
function addSpecial() {
    ...
    html += '    <td class="left"><input type="hidden" name="product_special[' + special_row + '][price]" value="" /><input type="text" name="product_special[' + special_row + '][date_start]" value="" class="date" /></td>';
