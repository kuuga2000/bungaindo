...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="vtabs" class="vtabs"><a href="#tab-customer"><?php echo $tab_customer; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a><a href="#tab-shipping"><?php echo $tab_shipping; ?></a><a href="#tab-product"><?php echo $tab_product; ?></a><a href="#tab-voucher"><?php echo $tab_voucher; ?></a><a href="#tab-total"><?php echo $tab_total; ?></a><a href="#tab-vendor"><?php echo $tab_vendor; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<tr>
				...
				<td>
					<select name="payment_to">
		                ...
		                <option value="BCA 2418018777 a/n Tan Kong Ie Isaphira T" <?php if(strstr($payment_to,'BCA') != ''){ ?> selected="selected" <?php } ?> >BCA 2418018777 a/n Tan Kong Ie Isaphira T</option>
		                <option value="Mandiri 900-00-0482321-8 a/n Tan Kong Ie Isaphira T" <?php if(strstr($payment_to,'Mandiri') != ''){ ?> selected="selected" <?php } ?> >Mandiri 900-00-0482321-8 a/n Tan Kong Ie Isaphira T</option>
						<option value="kaspay" <?php if(strstr($payment_to,'kaspay') != ''){ ?> selected="selected" <?php } ?> >Kaspay</option>
						<option value="credit" <?php if(strstr($payment_to,'credit') != ''){ ?> selected="selected" <?php } ?> >Credit</option>
		            </select>
				</td>
			</tr>
			<tr>
				<td>Payment From</td>
				<td><input type="text" name="payment_from" value="<?php echo $payment_from; ?>"></td>
			</tr>
			<tr>
				<td>Account Name</td>
				<td><input type="text" name="account_name" value="<?php echo $account_name; ?>"></td>
			</tr>
			<tr>
				<td>Total Amount</td>
				<td><input type="text" name="total_amount_paid" value="<?php echo $payment_total; ?>" readonly="readonly"></td>
			</tr>
			<tr>
				<td>Payment Date</td>
				<td><input type="text" name="payment_date" class="payment_date" value="<?php echo $payment_date; ?>" readonly="readonly"></td>
			</tr>
          </table>
        </div>
          ...
          <table class="list">
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="left"><?php echo $order_product['name']; ?><br /><?php if($order_product['shippingMethod'] != ''){echo '-'.$order_product['shippingMethod']; } ?>
				  ...
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][delivery_date]" value="<?php echo $order_product['delivery_date']; ?>"/>
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][shippingMethod]" value="<?php echo $order_product['shippingMethod']; ?>"/>
          ...
          <table class="list">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="left"><select name="order_status_id" onchange="$('#orderChanged').val(1)">
				  ...
				  <input  type="hidden" name="orderChanged" id="orderChanged" value="0"/>
				  </td>
              </tr>
              <tr>
		...
		<div id="tab-vendor" class="vtabs-content">
			<table class="list">
            <thead>
              <tr>
                <td class="left" colspan="2"><?php echo $text_vendor; ?></td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="left"><?php echo $entry_vendor; ?></td>
                <td class="left"><select name="vendors" id="vendors">				
                    <option value=""><?php echo $text_select_vendor; ?></option>
                    <?php if ($vendors) { 
						foreach($vendors AS $vendor) { ?>
                    <option value="<?php echo $vendor['vendor_id']; ?>" <?php if($vendor['vendor_id'] == $vendor_id) { ?> selected="selected"<?php } ?>><?php echo $vendor['firstname'].' '.$vendor['lastname']; ?></option>
                    <?php } } ?>
                  </select>
                  <input type="hidden" name="shipping_method" value="<?php echo $shipping_method; ?>" />
                  <input type="hidden" name="shipping_code" value="<?php echo $shipping_code; ?>" />
			  ...
			  <tr>
			  	<td>&nbsp;</td>
				<td class="left"><a id="button_update_vendor" class="button"><?php echo $button_update_vendor; ?></a></td>
			  </tr>
			  </tbody>
			  </table>
		</div>
...
//----------- order id added by gaurav on 3rd june-2013 to change status of order.
	$.ajax({
...
$('#button_update_vendor').click(function(){
	var vendor_id = $('#vendors').val();
	$.ajax({
			url: 'index.php?route=sale/order/assignOrderToVendor&token=<?php echo $token; ?>&vendor_id='+vendor_id+'&order_id=<?php echo $order_id; ?>',
			dataType: 'json',
			beforeSend: function() {
				$('#button_update_vendor').after('<span class="wait">&nbsp;<img src="view/image/loading.gif" alt="" /></span>');
			},
			complete: function() {
				$('.wait').remove();
			},			
