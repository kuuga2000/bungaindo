			...
			<tr>
				...
				<td>
					<select name="payment_to">
		                ...
		                <option value="BCA(0153363233) a/n Bunga Lestari" <?php if(strstr($payment_to,'BCA') != ''){ ?> selected="selected" <?php } ?> >BCA(0153363233) a/n Bunga Lestari</option>
		                <option value="Mandiri01532753533 a/n Bunga Lestari" <?php if(strstr($payment_to,'Mandiri') != ''){ ?> selected="selected" <?php } ?> >Mandiri01532753533 a/n Bunga Lestari</option>
