...
class ModelSaleCustomer extends Model {
	...
	public function approve($customer_id) {
		...
		if ($customer_info) {
			$this->db->query("UPDATE " . DB_PREFIX . "customer SET approved = '1', `activation_token` = '' WHERE customer_id = '" . (int)$customer_id . "'");
			...
			if ($store_info) {
				...
				$store_url = $store_info['url'] . 'index.php?route=account/login_register';
			} else {
				$store_name = $this->config->get('config_name');
				$store_url = HTTP_CATALOG . 'index.php?route=account/login_register';
			}
...
//--------- added by Gaurav on 4-06-2013 to get newsletter subscribtion emails.
	public function getNewsletterSubscribers()
	{
		$query = $this->db->query("SELECT newsletter_id,email FROM " . DB_PREFIX . "newsletter");
		return $query->rows;
	}									   	
}
?>