...
class ModelDesignLayout extends Model {
	...
	//************custom function for advertise lay out added by sheetal godase
	
	public function getLayoutsAdvertise($data = array()) {
		//$sql = "SELECT * FROM " . DB_PREFIX . "layout WHERE `name` LIKE 'home' or `name` LIKE 'category' " ;
		$sql = "SELECT * FROM " . DB_PREFIX . "layout " ;
