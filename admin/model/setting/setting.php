...
//-----------CUSTOM CODE TO GET MAX ORDER DURATION FROM STORE SETTINGS STARTS
	public function get_order_max_duration($group, $store_id = 0)	
	{
		$data = array(); 
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "setting WHERE store_id = '" . (int)$store_id . "' AND `group` = '" . $this->db->escape($group) . "' AND `key` LIKE 'config_order_duration'");
...
//-----------CUSTOM CODE TO GET MAX ORDER DURATION FROM STORE SETTINGS	ENDS
}
?>