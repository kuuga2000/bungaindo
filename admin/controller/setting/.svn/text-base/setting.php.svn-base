<?php
////$this->model_setting_setting->get_order_max_duration($group, $store_id = 0)
//$this->model_setting_setting->get_order_max_duration("config", $store_id = 0);// for testing
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_order_duration'] = $this->language->get('entry_order_duration');	
		...
		if (isset($this->error['telephone'])) {
 		...
 		//custom
		if (isset($this->error['order_duration'])) {
			$this->data['error_order_duration'] = $this->error['order_duration'];
		} else {
			$this->data['error_order_duration'] = '';
		}
		...
		if (isset($this->request->post['config_bbpin'])) {
			$this->data['config_bbpin'] = $this->request->post['config_bbpin'];
		} else {
			$this->data['config_bbpin'] = $this->config->get('config_bbpin');
		}
		...
		if (isset($this->request->post['config_order_duration'])) {
					$this->data['config_order_duration'] = $this->request->post['config_order_duration'];
		} else {
					$this->data['config_order_duration'] = $this->config->get('config_order_duration');
		}
	...
	protected function validate() {
		...
		//custom
		if ((!$this->request->post['config_order_duration']) || (!is_numeric($this->request->post['config_order_duration']))  ) {
			$this->error['order_duration'] = $this->language->get('error_order_duration');
		}
