...
require_once($vqmod->modCheck(DIR_SYSTEM . 'library/mail.php'));require_once($vqmod->modCheck(DIR_SYSTEM . 'library/class.phpmailer.php'));
...
require_once($vqmod->modCheck(DIR_SYSTEM . 'library/recaptchalib.php'));
?>