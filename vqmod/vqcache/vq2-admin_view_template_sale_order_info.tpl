...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="window.open('<?php echo $despatch; ?>&pdf=true');" class="button"><?php echo $button_pdf_invoice; ?></a><a href="<?php echo $invoice; ?>" target="_blank" class="button"><?php echo $button_invoice; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
		  ...
		  <tr>
				<td>Payment To</td>
				<td><?php echo $payment_to; ?></td>
			</tr>
			<tr>
				<td>Payment From</td>
				<td><?php echo $payment_from; ?></td>
			</tr>
			<tr>
				<td>Account Name</td>
